...
Item {
  ...
  // calm · alert (awaiting you) · peek (unread) · sleepy (muted)
  ...
  function path(ctx, s) {
    ...
    case "egg":
      ctx.moveTo(f(0.5), 0)
      ctx.bezierCurveTo(f(0.92), f(0.10), f(1.0), f(0.55), f(0.5), f(1.0))
      ctx.bezierCurveTo(f(0.0), f(0.55), f(0.08), f(0.10), f(0.5), 0)
      break
    case "capsule":
      ctx.roundedRect(f(0.12), 0, f(0.76), s, f(0.38), f(0.38)); break
    case "cylinder":
      ctx.roundedRect(f(0.14), f(0.02), f(0.72), f(0.96), f(0.30), f(0.16)); break
    case "tablet":
    ...
    case "bean":
      ctx.moveTo(f(0.30), f(0.06))
      ctx.bezierCurveTo(f(0.95), f(-0.06), f(1.05), f(0.62), f(0.72), f(0.94))
      ctx.bezierCurveTo(f(0.36), f(1.12), f(-0.02), f(0.78), f(0.14), f(0.42))
      ctx.bezierCurveTo(f(0.20), f(0.20), f(0.20), f(0.10), f(0.30), f(0.06))
      break
    case "pebble":
      ctx.moveTo(f(0.5), f(0.02))
      ctx.bezierCurveTo(f(0.94), f(0.06), f(1.02), f(0.52), f(0.86), f(0.84))
      ctx.bezierCurveTo(f(0.62), f(1.08), f(0.20), f(1.02), f(0.08), f(0.66))
      ctx.bezierCurveTo(f(-0.02), f(0.34), f(0.16), f(0.04), f(0.5), f(0.02))
      break
    case "cloud":
